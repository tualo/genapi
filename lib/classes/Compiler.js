    ...
    for(var f=0;f<enumEntry.length;f++){
      ...
      for(var efn=0;efn<EFNNAMES.length;efn++){
        if (entryItem[EFNNAMES[efn]]){
          me.addCodeLine( "\t"+'entry'+name+entryName+'.set'+EFNNAMES[efn]+'("'+entryItem[EFNNAMES[efn]]+'");');
          delete entryItem[EFNNAMES[efn]];
        }
        if (entryItem['p'+EFNNAMES[efn]]){
          me.addCodeLine( "\t"+'entry'+name+entryName+'.set'+'P'+EFNNAMES[efn]+'("'+entryItem['p'+EFNNAMES[efn]]+'");');
