...
IBasic.prototype.writeRawData = function(value){
  var me = this;
  //console.log('writeRawData',value);
  if (typeof me.address!=='undefined'){
    if (
      ...
      ( me.isAvailable*1!==0) &&
      (me.accessMode.indexOf('W')>=0) &&
      (typeof me.port !== 'undefined')
    ){
      me.port.write(me.address,value,function(err,register){
        if (err){
          console.log('-',err);
        }else{
  ...
  }else if (typeof me.P!=='undefined'){
    me.P.writeRawData(value);
  }
}
